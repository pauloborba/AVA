...
Scenario: Instrutor checa o número de questões certas por turma
Given Eu estou na página de "turmas"
And Eu estou logado com o CPF "1"
And A turma "IF688" teve "12" acertos no roteiro de "Requisitos" com ID "1"
When Eu acesso a turma "IF688"
And Eu acesso "Estatisticas" da turma "IF688"
Then Eu consigo ver que a turma "IF688" teve "12" acertos no roteiro de "Requisitos" com ID "1"
