...
defineSupportCode(function ({ Given, When, Then }) {
  ...
  // And O aluno "Guilherme Lima" respondeu à Questão "1" do roteiro "Testes", tendo realizado "5" perguntas
  // And O aluno "Mario Victor" concluiu o roteiro "Testes"
  // And O aluno "Mario Victor" desistiu da Questão "1" do roteiro "Testes", tendo realizado "10" perguntas
  ...
  Given('O aluno {string} finalizou à Questão "([^\"]*)" do roteiro {string}, tendo realizado "5" perguntas', (aluno, noquestao, nomeRoteiro, noperguntas) => {
  ...
  // Then O professor pode ver a Questão "1" com um total de perguntas de "15"
  Then('O professor pode ver a Questão "([^\"]*)" com um total de perguntas de "([^\"]*)"', (noquestao, nquestoes) => {
      // Write code here that turns the phrase above into concrete actions
  });
});
